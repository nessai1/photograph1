...
<body>
<nav class="mb-4 navbar navbar-expand-lg navbar-dark bg-dark" style="background: #131313 !important;">
    <a class="navbar-brand" href="/">Kaliningrad photograph</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-3">
        ...
        <ul class="navbar-nav ml-auto nav-flex-icons">
            ...
            <li class="nav-item">
                <a class="nav-link waves-effect waves-light"><i class="fa fa-vk"></i></a>
            </li>
